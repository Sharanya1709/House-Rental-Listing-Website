...
echo '<img src="data:img/jpeg;base64,'.base64_encode( $result['pics'] ).'"<br><br><center><br><a href="description.php?id='.$result['id'].'"class="button" >View Property </a></center><br>';
echo "</td></tr>";
}
echo "</table>";
?>
